  ...
  <transition name="fade">
    ...
    >
      <div class="bg-white p-8 rounded-xl shadow-2xl max-w-md w-full text-center">
        <div class="text-3xl font-bold text-red-600 mb-4">ROBBERY ALERT TRIGGERED!</div>

        <div class="text-xl mb-6">Broadcasting to your emergency contacts in:</div>

        <div class="text-8xl font-bold my-8 text-red-500">
          {{ countdown }}
        </div>

        <q-btn color="negative" size="lg" class="w-full py-3 text-lg" @click="cancel">
          CANCEL ALERT
        </q-btn>
      </div>
    </div>
