...
import {
  ...
  au as stop,
  a5 as debounce,
  aQ as setHorizontalScrollPosition,
  a7 as onDeactivated,
  a8 as onActivated,
  R as onBeforeUnmount,
  L as hMergeSlot,
  aR as setVerticalScrollPosition,
  a0 as watchEffect,
...
const TouchSwipe = createDirective({
  ...
  beforeMount(el, { value: value2, arg, modifiers }) {
    ...
    if (modifiers.mouse === true) {
      const capture =
        modifiers.mouseCapture === true || modifiers.mousecapture === true ? 'Capture' : ''
...
function useRenderCache() {
  ...
  return {
    getCache: (key, defaultValue) =>
      cache[key] === void 0
        ? (cache[key] = typeof defaultValue === 'function' ? defaultValue() : defaultValue)
        : cache[key],
    setCache(key, obj) {
      cache[key] = obj
    },
...
function usePanel() {
  ...
  function getPanelContentChild() {
    const panel =
      isValidPanelName(props.modelValue) === true && updatePanelIndex() && panels[panelIndex.value]
      ...
      start(evt, mouseEvent) {
        ...
        if (mouseEvent === true || modifiers.stop === true) {
          if (
            ...
            (mouseEvent !== true ||
              (ctx.modifiers.mouseAllDir !== true && ctx.modifiers.mousealldir !== true))
          ) {
            const clone =
  ...
  setup(props, { slots, emit }) {
    ...
    function onMousedown(evt, axis) {
      ...
      if (data.thumbHidden.value !== true) {
        const startOffset =
          axis === 'vertical' ? props.verticalOffset[0] : props.horizontalOffset[0]
        ...
        if (offset < thumbStart || offset > thumbStart + data.thumbSize.value) {
          ...
          const percentage = between(
            targetThumbStart / (container[axis + 'Inner'].value - data.thumbSize.value),
            0,
            1,
          )
              ...
              default: withCtx(() => [
                ...
                createVNode(QCardSection, null, {
                  default: withCtx(() => [
                    createVNode(
                      QScrollArea,
                      { style: { height: '230px', 'max-width': 'auto' } },
                      {
                        default: withCtx(() => [
                          createBaseVNode('div', _hoisted_2$2, [
                            ...
                            createElementBlock(
                              Fragment,
                              null,
                              renderList(__props.tips, (item, index) => {
                                return (
                                  openBlock(),
                                  createElementBlock(
                                    'div',
...
const _hoisted_1$1 = {
  class: 'relative border-2 border-gray-200 overflow-x-auto shadow-lg sm:rounded-lg',
}
const _hoisted_2$1 = {
...
const _hoisted_3$1 = {
  class:
    'p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800',
}
const _hoisted_4 = { class: 'mt-1 text-sm font-normal text-gray-500 dark:text-gray-400' }
const _hoisted_5 = {
  class:
    'text-xs text-center text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400',
}
const _hoisted_6 = {
  scope: 'row',
  class:
    'flex px-2 py-2 items-center self-center justify-center font-medium text-gray-900 whitespace-normal dark:text-white',
}
            ...
            createBaseVNode('table', _hoisted_2$1, [
              ...
              createBaseVNode('thead', _hoisted_5, [
                createBaseVNode('tr', null, [
                  ...
                  createElementBlock(
                    Fragment,
                    null,
                    renderList(__props.columns, (col, index) => {
                      return (
                        openBlock(),
                        createElementBlock(
                          'th',
              ...
              createBaseVNode('tbody', null, [
                ...
                createElementBlock(
                  Fragment,
                  null,
                  renderList(__props.rows, (row, rowIndex) => {
                    return (
                      openBlock(),
                      createElementBlock(
                        'tr',
                        {
                          key: rowIndex,
                          class:
                            'text-center odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700',
                        },
                        [
                          createBaseVNode('td', _hoisted_6, [
                            createBaseVNode('div', _hoisted_7, [
                              row.main === 'action' || row.main === 'action call'
                                ? (openBlock(),
                                  createBlock(
                                    QIcon,
                                    {
                            ...
                            row.main === 'action'
                              ? (openBlock(),
                                createElementBlock(
                                  ...
                                  toDisplayString(row.actions),
                                  9,
                                  _hoisted_11,
                                ))
                              : row.main === 'action call'
                                ? (openBlock(),
                                  createElementBlock(
                                    'a',
                                    {
                ...
                default: withCtx(() => [
                  createVNode(
                    QTabs,
                    {
                      ...
                      'onUpdate:modelValue':
                        _cache[0] || (_cache[0] = ($event) => (tab.value = $event)),
                      dense: '',
                  ...
                  createVNode(
                    QTabPanels,
                    {
                      modelValue: tab.value,
                      'onUpdate:modelValue':
                        _cache[1] || (_cache[1] = ($event) => (tab.value = $event)),
                      animated: '',
