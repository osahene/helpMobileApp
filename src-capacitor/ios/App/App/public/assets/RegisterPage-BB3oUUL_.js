                        ...
                        default: withCtx(() => [
                          ...
                          createVNode(
                            QInput,
                            {
                              ...
                              'onUpdate:modelValue':
                                _cache[0] ||
                                (_cache[0] = ($event) =>
                                  (unref($v).user.first_name.$model = $event)),
                              modelModifiers: { trim: true },
                              type: 'text',
                              error:
                                !unref($v).user.first_name.required &&
                                unref($v).user.first_name.$dirty,
                          ...
                          createVNode(
                            QInput,
                            {
                              ...
                              'onUpdate:modelValue':
                                _cache[1] ||
                                (_cache[1] = ($event) =>
                                  (unref($v).user.last_name.$model = $event)),
                              modelModifiers: { trim: true },
                              type: 'text',
                              error:
                                !unref($v).user.last_name.required &&
                                unref($v).user.last_name.$dirty,
                          ...
                          createVNode(
                            QInput,
                            {
                              ...
                              'onUpdate:modelValue':
                                _cache[2] ||
                                (_cache[2] = ($event) =>
                                  (unref($v).user.email_address.$model = $event)),
                              modelModifiers: { trim: true },
                              type: 'email',
                              error:
                                (!unref($v).user.email_address.required &&
                                  unref($v).user.email_address.$dirty) ||
                                (!unref($v).user.email_address.email &&
                                  unref($v).user.email_address.$dirty),
                          ...
                          createVNode(
                            QInput,
                            {
                              ...
                              'onUpdate:modelValue':
                                _cache[4] ||
                                (_cache[4] = ($event) => (unref($v).user.password.$model = $event)),
                              modelModifiers: { trim: true },
                              type: isPwd.value ? 'password' : 'text',
                              error:
                                (!unref($v).user.password.required &&
                                  unref($v).user.password.$dirty) ||
                                (!validPassword() && unref($v).user.password.$dirty),
                              ...
                              append: withCtx(() => [
                                createVNode(
                                  QIcon,
                                  {
                                    ...
                                    onClick:
                                      _cache[3] ||
                                      (_cache[3] = ($event) => (isPwd.value = !isPwd.value)),
                                  },
                                  null,
                                  8,
                                  ['name'],
                      ...
                      { class: 'text-center q-pt-none' },
                      {
                        default: withCtx(() => [
                          createBaseVNode('div', _hoisted_1, [
                            _cache[13] ||
                              (_cache[13] = createTextVNode(' Already have an account? ')),
                            createVNode(
