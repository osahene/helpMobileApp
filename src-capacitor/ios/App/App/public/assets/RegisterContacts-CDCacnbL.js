...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const rules = {
      ...
      phone_number: { required, validFormat: common.withMessage(
            ...
            default: withCtx(() => [
              createVNode(QCardSection, { class: "text-center text-h5" }, {
                default: withCtx(() => _cache[5] || (_cache[5] = [
                  createBaseVNode("div", { class: "text-grey-9 text-weight-light" }, "Register Contacts", -1)
                ])),
                _: 1,
                __: [5]
              }),
              ...
              createVNode(QCardSection, { class: "q-gutter-xs" }, {
                default: withCtx(() => [
                  ...
                  createVNode(QInput, {
                    ...
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => unref($v).first_name.$model = $event),
                  ...
                  createVNode(QInput, {
                    ...
                    "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => unref($v).last_name.$model = $event),
                    modelModifiers: { trim: true },
                    placeholder: "Henewaa",
                    type: "text",
                  ...
                  createVNode(QInput, {
                    ...
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => unref($v).email_address.$model = $event),
                    modelModifiers: { trim: true },
                    placeholder: "amahenewaa@example.com",
                    type: "email",
                    error: !unref($v).email_address.required && unref($v).email_address.$dirty,
                  ...
                  createVNode(QInput, {
                    ...
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => unref($v).phone_number.$model = $event),
                    modelModifiers: { trim: true },
                    placeholder: "+233240123456",
                    type: "text",
                    error: !unref($v).phone_number.required && unref($v).phone_number.$dirty,
                  ...
                  createVNode(QInput, {
                    ...
                    "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => unref($v).relation.$model = $event),
                    modelModifiers: { trim: true },
                    placeholder: "Son",
                    type: "text",
              ...
              createVNode(QCardSection, { class: "text-center" }, {
                default: withCtx(() => [
                  createVNode(QBtn, {
                    ...
                    style: normalizeStyle({ backgroundColor: unref($v).$anyDirty && !unref($v).$invalid ? "#007bff" : "#d3d3d3" }),
