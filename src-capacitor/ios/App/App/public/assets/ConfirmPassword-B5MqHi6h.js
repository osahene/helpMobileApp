...
import { r as ref, l as createBlock, m as openBlock, n as withCtx, f as createVNode, A as createBaseVNode, u as unref, Q as QIcon, E as QBtn, a1 as normalizeStyle } from "./index-Bs10UzzQ.js";
            ...
            default: withCtx(() => [
              createVNode(QCardSection, { class: "text-center text-h5" }, {
                default: withCtx(() => _cache[2] || (_cache[2] = [
                  createBaseVNode("div", { class: "text-grey-9 text-weight-light" }, "Confirm Password", -1)
                ])),
                _: 1,
                __: [2]
              }),
              createVNode(QCardSection, { class: "q-gutter-xs" }, {
                default: withCtx(() => [
                  _cache[3] || (_cache[3] = createBaseVNode("h6", { class: "q-ma-none q-mt-md text-weight-light" }, "New Password", -1)),
                  createVNode(QInput, {
                    class: "custom-input",
                    filled: "",
                    modelValue: unref($v).new_password.$model,
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => unref($v).new_password.$model = $event),
                  ...
                  _cache[4] || (_cache[4] = createBaseVNode("h6", { class: "q-ma-none q-mt-md text-weight-light" }, "Confirm Password", -1)),
                  createVNode(QInput, {
                    class: "custom-input",
                    filled: "",
                    modelValue: unref($v).confirm_password.$model,
                    "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => unref($v).confirm_password.$model = $event),
                    modelModifiers: { trim: true },
                    placeholder: "********",
                    type: "password"
                  }, {
