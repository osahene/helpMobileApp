...
const QImg = createComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    const { registerTimeout: registerLoadShowTimeout, removeTimeout: removeLoadShowTimeout } =
      useTimeout()
        ...
        createElementBlock('div', null, [
          createVNode(
            QDialog,
            {
              ...
              'onUpdate:modelValue':
                _cache[0] || (_cache[0] = ($event) => (localDialogOpen.value = $event)),
              persistent: '',
            },
            {
              default: withCtx(() => [
                              ...
                              { class: 'q-pt-xs text-center' },
                              {
                                default: withCtx(() => [
                                  createBaseVNode('div', _hoisted_1$3, [
                                    _cache[1] ||
                                      (_cache[1] = createBaseVNode('span', null, 'Heads Up', -1)),
                                  ...
                                  createBaseVNode('div', _hoisted_2$2, [
                                    createBaseVNode(
                                      'span',
                                      _hoisted_3$2,
                                      toDisplayString(__props.cardName1),
                                      1,
                                    ),
                                    createBaseVNode(
                                      'span',
                                      null,
                                      toDisplayString(__props.cardName2),
                                      1,
                                    ),
                                  ]),
                                  createBaseVNode(
                  ...
                  createElementBlock('div', _hoisted_1$2, [
                    createBaseVNode('div', _hoisted_2$1, [
                      ...
                      createVNode(
                        ...
                        {
                          default: withCtx(
                            () => _cache[0] || (_cache[0] = [createTextVNode(' CANCEL ALERT ')]),
                          ),
                          _: 1,
                          __: [0],
                        },
...
const RobberyCountdown = /* @__PURE__ */ _export_sfc(_sfc_main$2, [
  ['__scopeId', 'data-v-d7cbb035'],
])
function s(t) {
...
function f(t = false) {
  typeof window > 'u' ||
    ...
    window.Capacitor !== void 0 && !t ? s(window) : window.cordova !== void 0 && u(window))
}
const Geolocation = registerPlugin('Geolocation', {
  web: () =>
    __vitePreload(
      () => import('./web-DbO7umv_.js'),
      true ? __vite__mapDeps([0, 1, 2]) : void 0,
      import.meta.url,
    ).then((m) => new m.GeolocationWeb()),
})
f()
...
const _hoisted_1$1 = {
  class:
    'flex flex-col border-gray-900 justify-between backdrop-filter backdrop-blur-sm bg-opacity-10 bg-slate-200 overflow-hidden border-4 border-gray-200 rounded-xl shadow shadow-2xl',
}
...
const _hoisted_4 = {
  class:
    'head-title font-bold text-black text-[20px] xs:text-[25px] sm:text-[30px] md:text-[35px] lg:text-[40px] xl:text-[45px]',
}
const _hoisted_5 = {
  class:
    'head-title font-bold text-black text-[20px] xs:text-[25px] sm:text-[30px] md:text-[35px] lg:text-[40px] xl:text-[45px]',
...
const _hoisted_1 = {
  class: 'm-5 grid grid-cols-2 gap-7 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3',
}
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return (
        ...
        createBlock(
          QPage,
          { class: 'relative flex-1 flex-grow flex flex-col min-w-0 break-words w-full' },
          {
            default: withCtx(() => [
              createVNode(
                RobberyCountdown,
                  ...
                  renderList(cardInfo, (item, key) => {
                    return createBaseVNode('div', { key }, [
                      createVNode(
                        ...
                        null,
                        8,
                        ['card-title', 'card-title2', 'card-img', 'onClick'],
                      ),
                    ])
                  }),
                  64,
                  ...
                  ? (openBlock(),
                    createBlock(
                      _sfc_main$3,
                      {
                        ...
                        'onUpdate:modelValue':
                          _cache[0] || (_cache[0] = ($event) => (dialogOpen.value = $event)),
