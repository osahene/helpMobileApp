            ...
            default: withCtx(() => [
              createVNode(QCardSection, { class: "text-center text-h5" }, {
                default: withCtx(() => _cache[1] || (_cache[1] = [
                  createBaseVNode("div", { class: "text-grey-9 text-weight-light" }, "Email", -1)
                ])),
                _: 1,
                __: [1]
              }),
              createVNode(QCardSection, { class: "q-gutter-xs" }, {
                default: withCtx(() => [
                  _cache[2] || (_cache[2] = createBaseVNode("h6", { class: "q-ma-none q-mt-md text-weight-light" }, "Enter your Email", -1)),
                  createVNode(QInput, {
                    class: "custom-input",
                    filled: "",
                    modelValue: unref($v).email_address.$model,
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => unref($v).email_address.$model = $event),
