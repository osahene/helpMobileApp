...
const QFooter = createComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    const containerHeight = computed(() =>
      $layout.isContainer.value === true ? $layout.containerHeight.value : windowHeight.value,
    )
    const offset = computed(() => {
      ...
      const offset2 =
        $layout.scroll.value.position + containerHeight.value + size.value - $layout.height.value
