...
import { r as ref, o as onMounted, l as createBlock, m as openBlock, n as withCtx, f as createVNode, A as createBaseVNode, C as toDisplayString, H as normalizeClass, E as QBtn, G as withModifiers } from "./index-Bs10UzzQ.js";
            ...
            default: withCtx(() => [
              createVNode(QCardSection, { class: "text-center text-h5" }, {
                default: withCtx(() => _cache[1] || (_cache[1] = [
                  createBaseVNode("div", { class: "text-grey-9 text-weight-light" }, "Phone Number Verification", -1)
                ])),
                _: 1,
                __: [1]
              }),
              createVNode(QCardSection, { class: "q-gutter-xs" }, {
                default: withCtx(() => [
                  _cache[2] || (_cache[2] = createBaseVNode("h6", { class: "q-ma-none text-weight-light" }, "Enter the OTP", -1)),
                  createVNode(_sfc_main$1, {
                    modelValue: otpVal.value,
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => otpVal.value = $event)
                  }, null, 8, ["modelValue"]),
                  createBaseVNode("div", _hoisted_1, [
                    createBaseVNode("h6", _hoisted_2, "Resend in " + toDisplayString(timer.value) + " seconds", 1),
                    createBaseVNode("h6", {
                      class: normalizeClass(["q-ma-none q-mt-md text-weight-light", isDisabled.value ? "isDisable" : "isEnable"])
                    }, [
                      createVNode(QBtn, {
                        flat: "",
