...
import { t as reactive, c as computed, r as ref, k as resolveComponent, l as createBlock, m as openBlock, n as withCtx, f as createVNode, A as createBaseVNode, u as unref, M as createTextVNode, Q as QIcon, aY as withKeys, G as withModifiers, E as QBtn, a1 as normalizeStyle } from "./index-Bs10UzzQ.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const onSubmit = async () => {
      ...
      formData.append(
        "email",
        typeof user.email_address === "string" && user.email_address.includes("@") ? user.email_address.toLowerCase() : user.email_address
      );
            ...
            default: withCtx(() => [
              createVNode(QCardSection, { class: "text-center text-h5" }, {
                default: withCtx(() => _cache[4] || (_cache[4] = [
                  createBaseVNode("div", { class: "text-grey-9 text-weight-light" }, "Login with", -1)
                ])),
                _: 1,
                __: [4]
              }),
              ...
              createVNode(QCardSection, { class: "q-pa-sm text-center" }, {
                default: withCtx(() => _cache[6] || (_cache[6] = [
                  createBaseVNode("div", { class: "text-grey-8 text-weight-light text-h6 q-ma-none" }, " or ", -1)
                ])),
                _: 1,
                __: [6]
              }),
              createVNode(QCardSection, { class: "q-gutter-xs" }, {
                default: withCtx(() => [
                  _cache[7] || (_cache[7] = createBaseVNode("h6", { class: "q-ma-none q-mt-md text-weight-light" }, "Email Address or Phone Number", -1)),
                  createVNode(QInput, {
                    class: "custom-input",
                    filled: "",
                    modelValue: user.email_address,
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => user.email_address = $event),
                  ...
                  _cache[8] || (_cache[8] = createBaseVNode("h6", { class: "q-ma-none q-mt-md text-weight-light" }, "Password", -1)),
                  createVNode(QInput, {
                    class: "custom-input",
                    filled: "",
                    modelValue: unref($v).user.password.$model,
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => unref($v).user.password.$model = $event),
                    placeholder: "*********",
                    ...
                    append: withCtx(() => [
                      createVNode(QIcon, {
                        ...
                        onClick: _cache[1] || (_cache[1] = withModifiers(($event) => isPwd.value = !isPwd.value, ["prevent"]))
                      }, null, 8, ["name"])
                    ]),
                    _: 1
                  }, 8, ["modelValue", "type", "onKeydown"])
                ]),
                _: 1,
                __: [7, 8]
              }),
              createVNode(QCardSection, { class: "flex max-out q-py-none justify-around" }, {
                default: withCtx(() => [
                  createVNode(QCheckbox, {
                    dense: "",
                    modelValue: rem.value,
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => rem.value = $event),
                    label: "Remember me",
              ...
              createVNode(QCardSection, { class: "text-center" }, {
                default: withCtx(() => [
                  createVNode(QBtn, {
                    ...
                    style: normalizeStyle({ backgroundColor: !unref($v).$invalid ? "#b7d1ed" : "#d3d3d3" }),
                    flat: "",
                    class: "text-subtitle1 q-px-xl q-py-none q-ma-none shadow-2 text-weight-light",
                    icon: "fa-solid fa-arrow-right-to-bracket",
                    label: "Sign In",
                    onClick: onSubmit
                  }, null, 8, ["disable", "style"])
                ]),
                _: 1
              }),
              createVNode(QCardSection, { class: "text-center q-pt-none" }, {
                default: withCtx(() => [
                  createBaseVNode("div", _hoisted_1, [
                    _cache[10] || (_cache[10] = createTextVNode(" Don't have an account? ")),
                    createVNode(_component_router_link, { to: "/reg/register" }, {
                      default: withCtx(() => _cache[9] || (_cache[9] = [
                        createBaseVNode("span", { class: "text-blue-500" }, "Register", -1)
                      ])),
                      _: 1,
                      __: [9]
                    })
