import { I as createComponent, g as getCurrentInstance, h, U as hSlot, a2 as hUniqueSlot, Q as QIcon, c as computed, a3 as noop, r as ref, w as watch, a4 as nextTick, a5 as debounce, a6 as onBeforeMount, a7 as onDeactivated, a8 as onActivated, R as onBeforeUnmount, a9 as scrollTargetProp, aa as getScrollTarget, ab as listenOpts, o as onMounted, L as hMergeSlot, ac as useSizeProps, ad as useSize, ae as hDir, af as hMergeSlotSafely, ag as stopAndPrevent, ah as Ripple, J as useRouterLinkProps, K as useRouterLink, ai as isKeyCode, aj as prevent, ak as addEvt, al as cleanEvt, am as client, an as getScrollbarWidth, ao as position, ap as childHasFocus, S as Transition, aq as isDeepEqual, ar as shouldIgnoreKey, as as onBeforeUpdate, at as onUpdated, au as stop, av as vmHasRouter, aw as History, ax as isNumber, ay as isDate, az as isObject, aA as injectMultipleProps, aB as injectProp, E as QBtn, x as createElementBlock, m as openBlock, f as createVNode, n as withCtx, A as createBaseVNode, F as Fragment, y as renderList, l as createBlock, a1 as normalizeStyle, B as createCommentVNode, M as createTextVNode, u as unref, C as toDisplayString } from "./index-Bs10UzzQ.js";
...
import { u as useFieldEmits, a as useFieldProps, b as useField, c as useFieldState, d as useFormProps, e as useFormInputNameAttr, f as fieldValueIsFilled, g as useKeyComposition, Q as QInput } from "./QInput-C0L2HJsB.js";
import { c as clearSelection, n as normalizeToInterval } from "./format-D0aLtpjt.js";
import { p as portalProxyList, u as useModelToggleEmits, b as useTransitionProps, c as useModelToggleProps, d as useTransition, e as useModelToggle, f as usePortal, g as addEscapeKey, r as removeEscapeKey, h as addFocusout, i as removeFocusout, j as closePortalMenus, a as QDialog, Q as QCardActions } from "./QDialog-SglhtH9C.js";
...
import { b as fasExclamation, c as farCircleXmark, d as fasXmark, e as fasCircleCheck, g as farTrashCan, h as farPenToSquare } from "./index-BEVCGQIV.js";
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const isFormValid = computed(() => {
      return FirstName.value.trim() !== "" && LastName.value.trim() !== "" && EmailAddress.value.trim() !== "" && PhoneNumber.value.trim() !== "" && Relation.value.trim() !== "";
    });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => editInfoCard.value = $event),
          persistent: ""
        }, {
          default: withCtx(() => [
            createVNode(QCard, { class: "my-card" }, {
              default: withCtx(() => [
                _cache[11] || (_cache[11] = createBaseVNode("h5", { class: "text-xl px-5 pt-5 font-medium text-gray-900 dark:text-white" }, " Edit Emergency Contact ", -1)),
                createVNode(QCardSection, { class: "q-gutter-xs" }, {
                  default: withCtx(() => [
                    _cache[6] || (_cache[6] = createBaseVNode("h6", { class: "q-ma-none q-mt-xs text-weight-light" }, "First Name", -1)),
                    createVNode(QInput, {
                      class: "custom-input",
                    ...
                    _cache[7] || (_cache[7] = createBaseVNode("h6", { class: "q-ma-none q-mt-md text-weight-light" }, "Last Name", -1)),
                    createVNode(QInput, {
                      class: "custom-input",
                      filled: "",
                    ...
                    _cache[8] || (_cache[8] = createBaseVNode("h6", { class: "q-ma-none q-mt-md text-weight-light" }, "Email", -1)),
                    createVNode(QInput, {
                      class: "custom-input",
                      filled: "",
                    ...
                    _cache[9] || (_cache[9] = createBaseVNode("h6", { class: "q-ma-none q-mt-md text-weight-light" }, "Phone Number", -1)),
                    createVNode(QInput, {
                      class: "custom-input",
                      filled: "",
                    ...
                    _cache[10] || (_cache[10] = createBaseVNode("h6", { class: "q-ma-none q-mt-md text-weight-light" }, " Relation (Who are you to them? Ex: Their son) ", -1)),
                    createVNode(QInput, {
                      class: "custom-input",
                      filled: "",
                      modelValue: Relation.value,
                      "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => Relation.value = $event),
                      placeholder: "Son",
                      type: "text"
                    }, {
                      before: withCtx(() => [
                  ...
                  default: withCtx(() => [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(__props.buttons, (button, index) => {
                      return openBlock(), createBlock(QBtn, {
                        ...
                        style: normalizeStyle({ backgroundColor: !isFormValid.value && button.label === "Edit Info" ? "#d3d3d3" : "#b7d1ed" })
                      }, null, 8, ["onClick", "icon", "label", "disable", "style"]);
                    }), 128))
                  ]),
                  _: 1
                })
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        createVNode(QDialog, {
          ...
          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => actions.value = $event),
          persistent: ""
        }, {
          default: withCtx(() => [
            createVNode(QCard, { class: "my-card" }, {
                ...
                createBaseVNode("div", null, [
                  createBaseVNode("div", _hoisted_1$1, [
                    createBaseVNode("div", _hoisted_2$1, [
                      createBaseVNode("div", null, [
                        __props.actionType === "delete" ? (openBlock(), createElementBlock("h5", _hoisted_3$1, [
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(__props.actionIcon, (icon, index) => {
                      return openBlock(), createBlock(QIcon, {
                        key: index,
                        name: icon.name,
                        color: icon.color,
                        size: "xl"
                    ...
                    createBaseVNode("div", _hoisted_4$1, [
                      createBaseVNode("div", _hoisted_5$1, [
                        __props.message.highlight ? (openBlock(), createElementBlock("span", _hoisted_6$1, [
                          createTextVNode(toDisplayString(__props.message.text.split(__props.message.highlight)[0]) + " ", 1),
                          createBaseVNode("strong", _hoisted_7$1, toDisplayString(__props.message.highlight), 1),
                          createTextVNode(" " + toDisplayString(__props.message.text.split(__props.message.highlight)[1]), 1)
                        ])) : (openBlock(), createElementBlock("span", _hoisted_8$1, toDisplayString(__props.message.text), 1))
                      ])
                    ])
                  ])
                ]),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
                ...
                createVNode(QTable, {
                  ...
                  "body-cell-name": withCtx((props) => [
                    createBaseVNode("div", _hoisted_7, [
                      ...
                      createBaseVNode("div", _hoisted_9, toDisplayString(props.row.email_address), 1)
                    ])
                  ]),
                  _: 1
                }, 8, ["rows"])
        ...
        cardInfo.value ? (openBlock(), createBlock(_sfc_main$2, {
          key: 0,
          modelValue: openEdit.value,
          "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => openEdit.value = $event),
        ...
        }, null, 8, ["modelValue", "first_name", "last_name", "email_address", "phone_number", "relation", "buttons"])) : createCommentVNode("", true),
        cardInfo.value ? (openBlock(), createBlock(_sfc_main$1, {
          key: 1,
          modelValue: mainAction.value,
          "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => mainAction.value = $event),
          "action-icon": actionIcons.value,
          "action-type": toDoTask.value,
          message: actionMessage.value,
          buttons: actionButtons.value
        }, null, 8, ["modelValue", "action-icon", "action-type", "message", "buttons"])) : createCommentVNode("", true)
      ]);
    };
  }
};
