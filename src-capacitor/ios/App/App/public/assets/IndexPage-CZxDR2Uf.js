          ...
          { class: 'flex flex-center column q-pa-md' },
          {
            default: withCtx(() => [
              ...
              createElementBlock(
                Fragment,
                null,
                renderList(onBoardSteps, (item, index) => {
                    ...
                    createBaseVNode(
                      ...
                      [
                        ...
                        createBaseVNode('div', _hoisted_1, [
                          ...
                          item.title2
                            ? (openBlock(),
                              createElementBlock('h4', _hoisted_3, toDisplayString(item.title2), 1))
              ...
              createVNode(
                ...
                {
                  class:
                    'q-px-lg transparent q-py-sm flex justify-between items-center w-full bottom-0 footer-animate',
                },
                {
                  default: withCtx(() => [
                    ...
                    createBaseVNode('div', null, [
                      createBaseVNode('div', _hoisted_5, [
                        ...
                        createElementBlock(
                          Fragment,
                          null,
                          renderList(onBoardSteps, (item, idx) => {
                    ...
                    createBaseVNode('div', null, [
                      createVNode(
                        ...
                        {
                          default: withCtx(() => [
                            currentStep.value < onBoardSteps.length - 1
                              ? (openBlock(),
                                createBlock(QIcon, {
                                  key: 0,
